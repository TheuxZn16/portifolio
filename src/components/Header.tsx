...
function Header() {
	return (
		<header className="w-full z-10 h-28 bg-transparent backdrop-blur-sm  fixed top-0 left-0 flex items-center justify-center p-6">
			<div className="flex items-center gap-4 text-purple-bg">
				<a href="$">
