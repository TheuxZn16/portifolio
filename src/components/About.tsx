			...
			<div className="relative z-10 w-full h-full flex lg:flex-row flex-col justify-center items-center gap-6 md:gap-14">
				...
				>
					{texts.map((item) => (
						...
						>
							<h2 className="card-title text-2xl md:text-5xl font-bold mb-4 md:mb-8 text-transparent bg-clip-text bg-gradient-to-r from-[#7e3ff2] to-[#00ffff] drop-shadow-[0_0_15px_#00ffff] md:leading-loose">
